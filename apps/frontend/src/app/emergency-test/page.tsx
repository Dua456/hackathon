    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Emergency Countdown Test</h1>
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full px-6 py-4 bg-red-600 text-white text-xl font-bold rounded-lg hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {result && (
              ...
              >
                ...
                <p className={result === 'completed' ? 'text-red-700' : 'text-green-700'}>
                  {result === 'completed'
